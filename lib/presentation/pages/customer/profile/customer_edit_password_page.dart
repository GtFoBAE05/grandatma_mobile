...
class CustomerEditPasswordPage extends StatefulWidget {
  static const String ROUTE_NAME = '/customer_edit_password_page';

  const CustomerEditPasswordPage({Key? key});

  @override
  State<CustomerEditPasswordPage> createState() =>
      _CustomerEditPasswordPageState();
}

class _CustomerEditPasswordPageState extends State<CustomerEditPasswordPage> {
